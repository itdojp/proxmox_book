...
本書は大きく次のパートで構成される予定です。
現時点では TOC ファイルが存在しないため、ここで示す構成は ExecPlan に基づく暫定的なものです。
...
各章の詳細なタイトルや順番は、今後 TOC/summary ファイルが整備される段階で調整される可能性があります。
